...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2825be9e4132720c2ba483704f0e320b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Vincent HUGOT"; "Simon Cruanes"];
          homepage = None;
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "qtest.ml"});
               Library
                 ({
                     cs_name = "qcheck";
                     cs_data = PropList.Data.create ();
                   ...
                   {
                      lib_modules = ["QCheck"; "QCheck_runner"];
                      lib_pack = false;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "qcheck"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "Runner_test.ml"});
               Executable
                 ({
                     cs_name = "runner_ounit_example";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "Runner_ounit_test.ml"
                   });
               Executable
                 ({
                     cs_name = "runner_ounit2_example";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "Runner_ounit2_test.ml"
                   });
               Doc
                 ({
                     cs_name = "qcheck";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\197[\185\175\216\233!\227\015d\143t\141\002\193a";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
