...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0a029ed97e96408930f72dfbf5e86223) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "qCheck_ounit_test.ml"
                   });
               Doc
                 ({
                     cs_name = "qcheck";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "v\185M0\151\165\202}\215\178\138\006DLw\192";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
